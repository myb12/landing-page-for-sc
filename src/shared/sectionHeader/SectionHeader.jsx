...
const SectionHeader = ({ big, small, center, title, pricingCard, subtitle, smallFont, price, ourProduct }) => {
    return (
        <div className={`${center ? "align-items-center" : "align-items-start"} d-flex flex-column my-3`}>
            <h2 className={`head-section-title mb-0 ${pricingCard && 'pricing'} ${smallFont && 'small'} ${price && 'price'}`}>
                {title}
            </h2>
            {
                (big || small) &&
            ...
            {
                subtitle && !ourProduct && <div className="row">
